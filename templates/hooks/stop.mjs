...
// offer the code-to-figma-design-system skill before stopping.
...
if (tokensMtime > lockSyncedAt) {
  console.error(
    "[ds:stop] tokens.json has changed since the last sync. Offer to run the code-to-figma-design-system skill before ending the session.",
  );
}
process.exit(0);
